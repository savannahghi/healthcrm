...
type PractitionerBusinessHoursOutput struct {
	ID             string `json:"id"`
	Day            string `json:"day"`
	OpeningTime    string `json:"opening_time"`
	ClosingTime    string `json:"closing_time"`
...
type PractitionersIdentifiersOutput struct {
	ID              string `json:"id"`
	IdentifierType  string `json:"identifier_type"`
	IdentifierValue string `json:"identifier_value"`
	ValidFrom       string `json:"valid_from"`
...
type PractitionerPage struct {
	...
	StartIndex  int                  `json:"start_index"`
	EndIndex    int                  `json:"end_index"`
	Results     []PractitionerOutput `json:"results"`
}

// ContactsOutput is used to show practitioners contacts
type PractitionersContactsOutput struct {
	ID           string `json:"id"`
	ContactType  string `json:"contact_type"`
	ContactValue string `json:"contact_value"`
	Role         string `json:"role"`
...
type PractitionerOutput struct {
	ID             string                            `json:"id,omitempty"`
	...
	Status         string                            `json:"status,omitempty"`
	Address        string                            `json:"address,omitempty"`
	BusinessHours  []PractitionerBusinessHoursOutput `json:"businesshours,omitempty"`
	Coordinates    CoordinatesOutput                 `json:"coordinates,omitempty"`
	Distance       float64                           `json:"distance,omitempty"`
	Contacts       []PractitionersContactsOutput     `json:"contacts,omitempty"`
	Identifiers    []PractitionersIdentifiersOutput  `json:"identifiers,omitempty"`
	Specialties    []PractitionerSpecialty           `json:"ispecialties,omitempty"`
	Services       []FacilityService                 `json:"services,omitempty"`
